  ...
  return (
    <div className="flex flex-1 items-center justify-center p-8">
      <div className="w-full max-w-md rounded-xl border border-red-200 bg-red-50 p-8 text-center shadow-sm">
        ...
        <h2 className="mb-2 text-lg font-semibold text-gray-900">Could not load products</h2>
        <p className="text-sm text-gray-600">
          Failed to fetch product data. Check your Shopify credentials and try again.
        </p>
        {error.digest && (
